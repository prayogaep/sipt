                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <div class="form-icon">
                                                <input type="text" class="form-control form-control-icon" name="username" id="iconInput" value="<?= $user['username'] ?>" placeholder="Username" required>
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <div class="form-icon">
                                                <input type="password" class="form-control form-control-icon" name="password" id="iconInput" placeholder="Password">
