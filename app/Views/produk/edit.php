                        ...
                        <div class="live-preview">
                            <form action="/produk/update/<?= $produk['id_produk'] ?>" method="post" enctype="multipart/form-data">
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <div class="form-icon">
                                                <input type="text" class="form-control form-control-icon" name="nama_produk" id="iconInput" placeholder="Nama Produk" required value="<?= $produk['nama_produk']; ?>">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div>
                                            <label for="iconInput" class="form-label">Foto</label><br>
                                            <img src="<?= base_url() ?>img/<?= $produk['foto'] ?>" alt="" height="200">
                                            <br>
                                            <br>
                                            <div class="form-icon">
                                                <input type="file" class="form-control form-control-icon" name="foto" id="iconInput" placeholder="foto">
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
